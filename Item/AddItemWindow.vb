...
Public Class AddItemWindow
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If ITEMNAME.Text IsNot Nothing And ITEMCATEGORY.SelectedItem IsNot Nothing And UNITCOMBO.SelectedItem IsNot Nothing Then
            If ITEMCATEGORY.SelectedItem = Globals.resManager.GetString("lbEditCategories") Or ITEMCATEGORY.SelectedItem = "- - - - -" Then
                ToolTip1.Show(Globals.resManager.GetString("lbIncorrectCategory"), ITEMCATEGORY, 3000)
            Else
                If UNITCOMBO.SelectedItem = Globals.resManager.GetString("lbEditUnits") Or UNITCOMBO.SelectedItem = "- - - - -" Then
                    ToolTip1.Show(Globals.resManager.GetString("lbIncorrectCategory"), UNITCOMBO, 3000)
                Else
                    Dim cat_id = 0
                    Dim unit_id = 0
                    ...
                    Using ird As SqlCeDataReader = DatabaseHelper.cmd.ExecuteReader
                        While ird.Read()
                    ...
                    DatabaseHelper.cmd.ExecuteNonQuery()
                        ...
                        Using rd As SqlCeDataReader = DatabaseHelper.cmd.ExecuteReader
                            ...
                            If rd.GetValue(0).ToString IsNot "0" Then
                                ToolStripStatusLabel1.Text = Globals.resManager.GetString("lbItemsInDb") & rd.GetValue(0)
                            Else
                                ToolStripStatusLabel1.Text = Globals.resManager.GetString("lbItemsInDb") & "0"
                            End If
                        End Using
    ...
    Private Sub AddItemWindow_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ITEMCATEGORY.SelectedItem = "- - - - -"
        ITEMCATEGORY.Items.Add(Globals.resManager.GetString("lbEditCategories"))
        ...
        UNITCOMBO.Items.Add(Globals.resManager.GetString("lbEditUnits"))
    ...
    Private Sub ComboBox1_SelectedValueChanged(sender As Object, e As EventArgs) Handles ITEMCATEGORY.SelectedValueChanged
        If ITEMCATEGORY.SelectedItem = Globals.resManager.GetString("lbEditCategories") Then
    ...
    Private Sub UNITCOMBO_SelectedValueChanged(sender As Object, e As EventArgs) Handles UNITCOMBO.SelectedValueChanged
        If UNITCOMBO.SelectedItem = Globals.resManager.GetString("lbEditUnits") Then
